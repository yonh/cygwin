...
"cygwin-thread-multi-64int-2.5.0(0.29453)" or
	die "Errno architecture (cygwin-thread-multi-64int-2.5.0(0.29453)) does not match executable architecture ($Config{'archname'}-$Config{'osvers'})";
